...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_upload_view_icon = page.get_by_test_id('create-course-preview-image-upload-widget-info-icon')
        self.preview_upload_view_title = page.get_by_test_id('create-course-preview-image-upload-widget-info-title-text')
        self.preview_upload_view_description = page.get_by_test_id('create-course-preview-image-upload-widget-upload-button')
        self.preview_upload_button = page.get_by_test_id('create-course-preview-image-upload-widget-upload-button')
        self.preview_remove_button = page.get_by_test_id('create-course-preview-image-upload-widget-remove-button')
        self.preview_image = page.get_by_test_id('create-course-preview-image-upload-widget-preview-image')
        self.preview_image_upload_input = page.get_by_test_id('create-course-preview-image-upload-widget-preview-input').locator('input')
    ...
    def check_visible_image_preview_upload(self, is_image_uploaded:bool = False):
        ...
        expect(self.preview_upload_view_title).to_have_text('Tap on "Upload image" button to select file')

        expect(self.preview_upload_view_description).to_be_visible()
        expect(self.preview_upload_view_description).to_have_text('Recommended file size 540X300')
