...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_button = page.get_by_test_id(f'{identifier}-image-upload-widget-upload-button' )
        self.image_remove_button = page.get_by_test_id(f'{identifier}-image-upload-widget-remove-button')
