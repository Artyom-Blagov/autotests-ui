...
class SidebarComponent(BaseComponent):
    ...
    def click_logout(self):
        self.logout_list_item.check_navigation(re.compile(r'.*/#/auth/login'))

    @allure.step('Click courses on sidebar')
    def click_courses(self):
        self.courses_list_item.check_navigation(re.compile(r'.*/#/courses'))

    @allure.step('Click dashboard on sidebar')
    def click_dashboard(self):
        self.dashboard_list_item.check_navigation(re.compile(r'.*/#/dashboard'))
